...
{
    public static IEnumerable<OrderDto> ToOrderDtoList(this IEnumerable<Order.Domain.Models.Orders> orders)
    {
    ...
    public static OrderDto ToOrderDto(this Order.Domain.Models.Orders order)
    {
        return DtoFromOrder(order);
    }

    private static OrderDto DtoFromOrder(Order.Domain.Models.Orders order)
    {
        return new OrderDto(
                    Id: order.Id.Value,
                    CustomerId: order.CustomerId.Value,
